    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(editable=False, max_length=11, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution_model', models.CharField(choices=[('pay', 'Платная лицензия'), ('free', 'Бесплатная лицензия'), ('none', 'Без модели')], default='none', max_length=50)),
