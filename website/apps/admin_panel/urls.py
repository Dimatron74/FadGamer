...
urlpatterns = [
    ...
    path('api/user/promocodes/activate/', api.activate_promocode, name='activate-promocode'),
    path('api/user/promocodes/my/', api.get_my_active_promocodes, name='my-promocodes'),
]